...
def build_user_message(data: Dict[str, Any]) -> Dict[str, Any]:
    ...
    if is_unblock:
        ...
        text = (
            ...
            "❗ <b>На ИмяСервиса запрещено</b> скачивание через <b>torrent</b> — это мешает другим пользователям.\n\n"
